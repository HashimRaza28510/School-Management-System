...
public class Database {
    ...
    public Database() throws ClassNotFoundException, SQLException{
        ...
        conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/SMDB","root","root");
    }
    ...
    String name = "";  
    String query = "SELECT FirstName, MiddleName, LastName FROM Student WHERE StudentID= "+keyword+" ";
    stmt = conn.prepareStatement(query);
    ...
    public static int grader(MainFiles.Roster r1) throws SQLException{
